...
public static class AvalonEditBehaviors
{
    ...
    private static void OnEditorTextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
    {
        ...
        EditorState state = _states.GetOrCreateValue(editor);
    ...
    public static int GetCaretOffset(DependencyObject obj)
    {
        return (int)obj.GetValue(CaretOffsetProperty);
    }

    public static void SetCaretOffset(DependencyObject obj, int value)
    {
        obj.SetValue(CaretOffsetProperty, value);
    }
    ...
    public static bool GetIsModified(DependencyObject obj)
    {
        return (bool)obj.GetValue(IsModifiedProperty);
    }

    public static void SetIsModified(DependencyObject obj, bool value)
    {
    ...
    public static ICommand? GetShowCompletionCommand(DependencyObject obj)
    {
        return (ICommand?)obj.GetValue(ShowCompletionCommandProperty);
    }

    public static void SetShowCompletionCommand(DependencyObject obj, ICommand? value)
    {
        obj.SetValue(ShowCompletionCommandProperty, value);
    }
    ...
    private static void EnsureHandlers(TextEditor editor)
    {
        ...
        if (editor.TextArea != null)
        {
            editor.TextArea.PreviewKeyDown += (_, e) =>
            {
                ...
                if (!ctrl || pressedKey != Key.Space) { return; }

                ICommand? cmd = GetShowCompletionCommand(editor);
